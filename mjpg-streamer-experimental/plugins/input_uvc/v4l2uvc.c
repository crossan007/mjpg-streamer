...
static int init_v4l2(struct vdIn *vd)
{
    ...
    vd->formatIn = V4L2_PIX_FMT_JPEG; //TODO: this is janky, but works for https://github.com/jacksonliam/mjpg-streamer/issues/298
    vd->fmt.fmt.pix.pixelformat = V4L2_PIX_FMT_JPEG; //TODO: this is janky, but works for https://github.com/jacksonliam/mjpg-streamer/issues/298
